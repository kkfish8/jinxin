...
<meta http-equiv="expires" content="0">   <title>个人中心</title>
...
<script>
	...
	$(document).ready(function() {
		$('.basis_save').click(function() {
			...
			$.post("UpdateInfo.do",{"mail":mail,"name":name,"sex":sex,"number":number},function(data){
				if(data=="ok")
					alert("修改成功");
				else
					alert("修改失败");
		...
		<div class="user_right">
			<div class="user_right_title">
				<ul class="user_right_tab" id="user_right_tab">
					...
					<li class="active"><a href="changeInfo.do">修改资料</a></li>
				...
				<div class="right_contetn_basis" id="right_content_table">
					...
					<table style="display: block;">
						<tr>
							...
							<td><input type="text" id="name" value="${us.name }"></td>
						</tr>
						<tr>
							<td class="right_table_name">性别：</td>
							<td><input type="text" id="sex" value="${us.sex }"></td>
						</tr>
						<tr>
							<td class="right_table_name">电话：</td>
							<td><input type="text" id="number" value="${us.number }"></td>
						</tr>
						<tr>
							<td class="right_table_name">E-mail：</td>
							<td><input type="text" id="mail" value="${us.mail }"></td>
						</tr>
						<tr>
							<td colspan="2"><input type="button" value="保存信息"
								class="basis_save"></td>
						</tr>
					</table>
